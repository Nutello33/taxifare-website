...
pickup_date_long = pickup_date.strftime("%A, %B %d")
st.write("✅ OK, got it :", pickup_date_long)
pickup_time = st.time_input("Pickup time")
st.write("👌🏼 All good ! We'll be there at ", pickup_time.strftime("%H:%M"))
